...
draw_channels = ["ap_data_10m.csv - Vector magnitude_max", "ap_data_10m.csv - Vector magnitude_std", "ah_data_10m.csv - AH_Activity_mean", "ah_data_10m.csv - AH_Activity_std", "ah_data_10m.csv - AH-ECG_mean", "ah_data_10m.csv - AH-ECG_max"]
