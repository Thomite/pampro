...
def calibrate(x,y,z, allow_overwrite=True, budget=7500, noise_cutoff_mg=13):
	...
	still_x, still_x_std = x.build_statistics_channels(still_bouts, ["mean", "std"])
	...
	#print("calibrate E")
	ts_still.add_channels([still_x, still_y, still_z])
...
def evaluate_solution_2(solution):
    ...
    x,y,z = ts_still.get_channel("still_x"),ts_still.get_channel("still_y"),ts_still.get_channel("still_z")
